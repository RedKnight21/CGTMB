/*=========================================================================
  ...
  Module:    sssIntersectionPolyDataCheck.h
...
=========================================================================*/
/**
 * @class   sssIntersectionPolyDataCheck
 *
 * This class is a modification of vtkIntersectionPolyDataCheck that returns
 * indicators as to whether or not the inputs intersect. Other operations
 * perfomred by vtkIntersectionPolyDataCheck do not take place here.
 *
 * It is intended to call this class to see if vtkIntersectionPolyDataCheck
 * should be called later. Used in sssBooleanOperationCheck.
 *
 * Unfortunately, at this time, a lot of the baggage from vtkIntersectionPolyDataCheck
 * is left in place -- to be dealt with later.
 *
 * sssIntersectionPolyDataCheck computes the intersection between two
...
#ifndef sssIntersectionPolyDataCheck_h
#define sssIntersectionPolyDataCheck_h
...
public:
  ...
  vtkTypeMacro(sssIntersectionPolyDataCheck, vtkPolyDataAlgorithm);
...
protected:
  sssIntersectionPolyDataCheck();           // Constructor
  ~sssIntersectionPolyDataCheck() override; // Destructor
...
private:
  sssIntersectionPolyDataCheck(const sssIntersectionPolyDataCheck&) = delete;
  void operator=(const sssIntersectionPolyDataCheck&) = delete;
...
#endif // sssIntersectionPolyDataCheck_h
